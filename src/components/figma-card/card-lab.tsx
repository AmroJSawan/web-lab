...
const SURFACE_TOGGLES: Array<{ key: keyof CardSettings; label: string }> = [
  ...
  { key: 'showGlass', label: 'WebGL glass refraction + specular' },
  { key: 'showLiquidGlass', label: 'Liquid glass (CSS/SVG)' },
...
const SLIDERS: Array<{
  ...
  { key: 'fxNeutral', label: 'Neutral color (0 = Figma peach)', min: 0, max: 1, step: 0.01 },
